...
\end{itemize}
We compare our STFT MLE implementation against the results reported in \cite{das2021} and our own MWF baseline.
...
\begin{figure}[t]
    \centering
    \includeifexists{../run/sdr_comparison.png}{width=0.9\columnwidth}
